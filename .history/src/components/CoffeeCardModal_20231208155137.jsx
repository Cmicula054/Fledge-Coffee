          ...
          <Grid item xs={12} sm={7}>
            ...
            <FormControl component="fieldset">
              <RadioGroup
                ...
                row
              >
                <FormControlLabel value="250g" control={<Radio />} label="250 grams" />
                <FormControlLabel value="1kg" control={<Radio />} label="1 kg" />
                <FormControlLabel value="2.5kg" control={<Radio />} label="2.5 kilo" />
              </RadioGroup>
            </FormControl>
            <Grid container spacing={1} alignItems="center" justifyContent="center" sx={{ my: 2 }}>
              <Button>-</Button>
              <TextField
                id="quantity"
                type="number"
